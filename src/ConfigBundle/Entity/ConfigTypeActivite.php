 ...
 * ConfigTypeActivite
 *
 * @ORM\Table(name="config_type_activite")
 * @ORM\Entity(repositoryClass="ConfigBundle\Repository\ConfigTypeActiviteRepository")
 */
class ConfigTypeActivite
{
    /**
     * @var int
     *
